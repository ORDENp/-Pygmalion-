...
function calculateBurnAt(createdAt) {
    ...
    // Импульсные У.Е. (20:00-04:00) → burnAt = послезавтра 00:00 (+2 дня)
    // Активные У.Е. (04:00-19:55) → burnAt = завтра 00:00 (+1 день)
    const daysToAdd = (emissionHour >= 20 || emissionHour < 4) ? 2 : 1;
